  ...
  public class OS50kGazetteer
  {
    ...
    public OS50kGazetteer(string line)
    {
      ...
      else
      {
        ...
        string match = DoubleMetaphone.GetPrimaryMetaphone(DefinitiveName);
        FuzzyMatch = match + ":";
        FuzzyNoParishMatch = match + ":";
        match = DoubleMetaphone.GetPrimaryMetaphone(ParishName);
        FuzzyMatch += match + ":";
        match = DoubleMetaphone.GetPrimaryMetaphone(CountyName);
        FuzzyMatch += match + ":";
        FuzzyNoParishMatch = match + ":";
        match = DoubleMetaphone.GetPrimaryMetaphone(county.CountryName);
        FuzzyMatch += match;
        FuzzyNoParishMatch = match + ":";
      }
    }
